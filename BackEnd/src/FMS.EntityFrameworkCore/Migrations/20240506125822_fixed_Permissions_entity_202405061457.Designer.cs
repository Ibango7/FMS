...
namespace FMS.Migrations
{
    ...
    [Migration("20240506125822_fixed_Permissions_entity_202405061457")]
    partial class fixed_Permissions_entity_202405061457
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMS.Domain.FilePermissions.FilePermissionManagement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool?>("AsOwner")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("FilePermissionManagement");
                });

            modelBuilder.Entity("FMS.Domain.notification.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FMS.Domain.notification.Notification", b =>
                {
                    b.HasOne("FMS.Authorization.Users.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FMS.Authorization.Users.User", "Sender")
                        .WithMany()
